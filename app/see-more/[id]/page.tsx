        ...
        <>
            ...
            <div className="w-9/12 mx-auto mt-10 md:flex gap-5 flex-row-reverse">
                ...
                <div className="md:w-[70%]">
                  <h1 className='text-2xl lg:text-4xl text-white lg:font-semibold mt-8'>Our expert is ready to help you with complex processes. Schedule a free consultation.</h1>
                  <h1 className='text-lg lg:text-xl text-white lg:font-semibold my-5'>SERGEY AVDEYCHIK, Director of Healthcare Technologies at Andersen</h1>
                  <button className='text-white px-5 py-2 mb-8 bg-[#23beec] hover:bg-[#23beec] text-md font-bold rounded'>Request consultation</button>
                </div>
            </div>
            <DeteilsSectionContainer>
                <BookAFree/>
