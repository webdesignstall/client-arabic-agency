                ...
                <div className='m-auto flex justify-between items-center'>
                    ...
                    <div className="lg:flex space-x-6 hidden">
                        ...
                        <div className='flex items-center pl-3 gap-5'>
                            ...
                            {
                                locale ==='ar'?
                                <button onClick={() => handleLocaleSwitch('en')}className='text-white px-5 py-2 bg-[#23beec] hover:bg-[#23beec] text-md font-bold rounded pointer'>English</button>
                                :
                                <button onClick={() => handleLocaleSwitch('ar')}className='text-white px-5 py-2 bg-[#23beec] hover:bg-[#23beec] text-md font-bold rounded pointer'>Arabic</button>
                            }
                        </div>
                    </div>
