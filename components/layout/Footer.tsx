...
export default function Footer() {
  const offices = [
    {
      city: "Cologne",
      address: "Zollstockgürtel 67",
      country: "Germany",
      phone: "+49 22 198 253 169",
    },
    {
      city: "Krakow",
      address: "ul. Al. Pokoju 18 B3",
      country: "Poland",
      phone: "+48 22 390 64 08",
    },
    {
      city: "Warsaw",
      address: "Rondo Daszyńskiego 1, 23 floor",
      country: "Poland",
      phone: "+48 22 390 64 08",
    },
    {
      city: "London",
      address: "30 St Mary's Axe",
      country: "UK",
  ...
  return (
    <div className="sm:py-16 sm:px-20 py-5 px-8 ">
        ...
        <div className="grid md:grid-cols-4 grid-cols-2  gap-4">
          {offices.map((office, index) => (
            <div
              ...
              key={index}
            >
              <h2 className="font-bold mb-4 lg:text-lg md:text-sm">
                {office.city}
              </h2>
              <div className="lg:text-base md:text-xs">
                <p>{office.address}</p>
                <p>{office.country}</p>
                <div className="mt-4">
      ...
      <div className="text-white py-12 border-t  border-gray-700">
        ...
        <div className="lg:text-base lg:flex justify-between w-2/3 sm:grid">
          <div>
            {" "}
      ...
      <div className="mt-8 text-center text-white">
        {/* <p className="text-sm">
          Copyright © 2024 UAB Andersen Soft. All rights reserved.
        </p> */}
        <div className="lg:flex items-center justify-between px-4 py-6 text-gray-500 border-t border-gray-200 md:grid">
