...
export default function AboutProject() {
    return (
        <SectionContainer>
            <h1 className='text-4xl font-medium'>About the project</h1>
            ...
            <p className='mt-10 grid grid-cols-3 col-span-2'> <span className='col-span-2'>The resulting user flow is as follows. A patient uploads their photo and answers several questions. After that, proprietary AI-driven algorithms analyze their skin type and other characteristics and connect the client with a doctor. The doctor produces a skin care product (i.e. serum), tailored to the client's needs, from Universkin's ingredients. Then, the client receives the product, which specifically matches their skin type, by post.</span></p>
            <p className='mt-10 grid grid-cols-3'><span className='col-span-2'>While working on this platform, our team of Pharma industry software experts, in close collaboration with the customer, gathered and analyzed tech requirements, developed the front-end and back-end parts, integrated the customer's AI into the back-end, tuned all notifications, and implemented communication channels.</span></p>
            <h1 className="text-xl text-[#B2B2B2] mt-10">LOCATION: <span className="pl-10 text-black">24 months</span></h1>
            <div className='flex gap-5 mt-10'>
                <h1 className="text-xl text-[#B2B2B2]">TECHNOLOGIES</h1>
