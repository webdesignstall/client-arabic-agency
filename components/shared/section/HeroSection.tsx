...
export default function HeroSection({homeData}) {
    return (
        <div>
          <div>
            <div className={`relative m-auto bg-cover h-[30vh] lg:h-[70vh] bg-[url("https://images.unsplash.com/photo-1704658492989-e4a4d1db44ba?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")]`}>
