...
export default function ModalCall() {
    ...
    return (
        <div className=''>
            ...
            <div className={`fixed bg-[#000000c9] left-0 z-50 w-full h-full duration-500 ${drawer ? 'top-0' : 'top-[-3333px]'}`}>
                <div className='w-full max-w-6xl bg-white m-auto mt-10'>
                    <div className="relative flex justify-between">
                        ...
                        <div className="w-[50%] rounded-l-md p-16">
                            <h1 className="text-4xl font-medium mb-4">Booking a Call</h1>
                            <p className='py-4'>Select an available slot to get in touch with Andersen so that one of our representatives can contact you and start a discussion</p>
                        ...
                        <div className="w-[50%] bg-[#25303e] p-16 rounded-r-md">
